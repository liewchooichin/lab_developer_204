async function displayUI() {    
    ...
    // Show a button that a signed-in user can select to view their 
    // profile photo. The button will remain hidden if the user isn't 
    // signed in.
    var showPhotoButton= document.getElementById('showProfilePhoto');
    showPhotoButton.style = "display: block";
}
// Display the image response received from Microsoft Graph
